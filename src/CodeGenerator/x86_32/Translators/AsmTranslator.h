...
public:
    ...
    // Generated (test part)
    void ADC_rm32_reg32(RM op1, Register op2);
    void ADC_rm8_reg8(RM op1, Register op2);
    ...
    void OR_AL_imm8(uint8_t op2);
    void OR_EAX_imm32(uint32_t op2);
    void OR_reg32_rm32(Register op1, RM op2);
    void OR_reg8_rm8(Register op1, RM op2);
